...
python -m torch.distributed.run --nproc_per_node=2 \
    ...
    training.epochs=60 \
    training.lr=5e-4 \
    task_name=debug_multimodal_da_randombg_atms_amsua_mhs_prepbufr_satwnd_ascat_20260624
    > slurmlogs/debug_multimodal_da_randombg_atms_amsua_mhs_prepbufr_satwnd_ascat_20260624.log