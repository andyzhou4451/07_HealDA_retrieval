...
nohup python -m torch.distributed.run --nproc_per_node=2 \
    ...
    datamodule.start_train_year=2021 \
    ...
    training.pretrain_ckpt=logs/debug_pretrain_xichen_state_forecast_20260526/runs/checkpoints/best.ckpt \
    task_name=debug_finetune_xichen_state_forecast_ar2_20260526 \
    > slurmlogs/debug_finetune_xichen_state_forecast_ar2_20260526.log 2>&1 &