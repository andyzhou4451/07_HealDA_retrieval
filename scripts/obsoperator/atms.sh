...
python -m torch.distributed.run --nproc_per_node=2 \
    ...
    datamodule=obsoperator/atms.yaml \
    datamodule.batch_size=48 \
    datamodule.start_train_year=2016 \
    datamodule.debug=False \
    model=obsoperator/xichen_atms_obsoperator.yaml \
    ...
    task_name=train_atms_obsop_20260608 \
    > slurmlogs/train_atms_obsop_20260608.log 2>&1