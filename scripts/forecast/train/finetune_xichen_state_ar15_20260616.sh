...
python -m torch.distributed.run --nproc_per_node=2 \
    ...
    training.pretrain_ckpt=logs/finetune_xichen_state_forecast_ar15_20260612/runs/checkpoints/best.ckpt \
    task_name=finetune_xichen_state_forecast_ar15_20260616 \
    > slurmlogs/finetune_xichen_state_forecast_ar15_20260618.log 2>&1