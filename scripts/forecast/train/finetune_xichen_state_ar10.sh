...
nohup python -m torch.distributed.run --nproc_per_node=2 \
    ...
    training.pretrain_ckpt=logs/finetune_xichen_state_forecast_ar8_20260529/runs/checkpoints/best.ckpt \
    task_name=finetune_xichen_state_forecast_ar10_20260530 \
    > slurmlogs/finetune_xichen_state_forecast_ar10_20260530.log 2>&1 &