...
nohup python -m torch.distributed.run --nproc_per_node=2 \
    ...
    training.pretrain_ckpt=logs/finetune_xichen_state_forecast_ar4_20260527/runs/checkpoints/best.ckpt \
    task_name=finetune_xichen_state_forecast_ar6_20260528 \
    > slurmlogs/finetune_xichen_state_forecast_ar6_20260528.log 2>&1 &