...
@click.option("--obs_dir", type=click.Path(exists=True), default=os.environ.get("OBS_DIR", "/public02/data/Observation/observation_npy/satwnd_merged_npy_1.0deg"))
@click.option("--save_dir", type=str, default=os.environ.get("OBS_DIR", "/public02/data/Observation/observation_npy/satwnd_merged_npy_1.0deg"))
@click.option(
    "--variables",
    "-v",
    type=click.STRING,
...
def main(
    ...
    obs_sigma = {}
    obs_sigma = compute_sigma(era5_dir, obs_dir, variables, year, save_dir, resolution, dt, np_devaition, obs_sigma, skip_missing=True)
