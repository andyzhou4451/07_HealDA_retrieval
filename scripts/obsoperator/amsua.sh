...
python -m torch.distributed.run --nproc_per_node=2 \
    ...
    training.resume_pretrain=True \
    task_name=train_amsua_obsop_20260610 \
    > slurmlogs/train_amsua_obsop_20260610.log 2>&1